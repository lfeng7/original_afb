...
#generated PDF set
Pdf_weights = array('d',150*[0.])
t.Branch('Pdf_weights',Pdf_weights,'Pdf_weights[45]/D')
#generator info
qscale    = array('f',[0.])
...
for event in events:
	...
	if options.mc == 'yes' :
		...
		#top pT reweighting
		if options.sample_type == 'signal' or options.sample_type == 'Powheg_qq_semilep_TT' or options.sample_type == 'Powheg_gg_semilep_TT' :
