...
for event in events:
	...
	if options.mc == 'yes' :
		#PDF REWEIGHTING
		if options.tMotherCheck == 'qq' or options.tMotherCheck == 'gg' or options.sample_type == 'Powheg_dilep_TT' or options.sample_type == 'TTJets_FullLep' or options.sample_type == 'TTJets_Hadronic'  or options.sample_type == 'signal':
			#Get PDF weights
